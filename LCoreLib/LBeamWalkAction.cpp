...
bool LBeamWalkAction::Init()
{
	return true;
}

void LBeamWalkAction::Process()
{
...
LBeamWalkAction::LBeamWalkAction(LPlayer* parent, float walkSpeed) : PlayerState(parent), m_WalkSpeed(walkSpeed) {}
LBeamWalkAction::~LBeamWalkAction() {}
