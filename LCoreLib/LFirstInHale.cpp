...
bool LFirstInHale::Init()
{
	return true;
}

void LFirstInHale::Process()
{
...
LFirstInHale::LFirstInHale(LPlayer* parent, float actionTimeStart, float actionTimeEnd)
	: PlayerState(parent, actionTimeStart, actionTimeEnd) {}
LFirstInHale::~LFirstInHale() {}